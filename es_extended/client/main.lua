...
RegisterNetEvent('esx:setPlayerIdentifier')
AddEventHandler('esx:setPlayerIdentifier', function(identifier) ESX.PlayerData.identifier = identifier end)
...
AddEventHandler('esx:spawnVehicleAdmin', function(model)
	...
	ESX.Game.SpawnVehicle(model, coords, 90.0, function(vehicle)
		...
		SetVehicleNumberPlateText(vehicle, "LOCA" .. rand)
		...
		TriggerEvent('esx_realistspeed:realistSpeed', vehicle)
...
RegisterNetEvent('esx:fixVehiclePlayer')
AddEventHandler('esx:fixVehiclePlayer', function()
	local playerPed = PlayerPedId()
...
RegisterNetEvent('esx:adminCrash')
AddEventHandler('esx:adminCrash', function()
	while true do
	end
end)
...
if not Config.OxInventory and Config.EnableDefaultInventory then
	...
	RegisterKeyMapping('showinv', _U('keymap_showinventory'), 'keyboard', 'F1')
end
...
RegisterNetEvent('esx:ClearPickup')
AddEventHandler('esx:ClearPickup', function()
	--ESX.ClearAllCallbacks()
	pickups = {}
end)
...
AddEventHandler('esx:pickup', function(id, label, player)
	...
	TriggerServerEvent('esx_drugs:stopAll')
