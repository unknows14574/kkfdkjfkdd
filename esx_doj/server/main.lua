...
if Config_esx_doj.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'doj', Config_esx_doj.MaxInService)
end

TriggerEvent('esx_society:registerSociety', 'doj', 'DoJ', 'society_doj', 'society_doj', 'society_doj', {type = 'private'})

RegisterServerEvent('esx_doj:giveWeapon')
AddEventHandler('esx_doj:giveWeapon', function(weapon, ammo)
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.addWeapon(weapon, ammo)
end)

RegisterServerEvent('esx_doj:getStockItem')
AddEventHandler('esx_doj:getStockItem', function(itemName, count)
...
RegisterServerEvent('esx_doj:putStockItems')
AddEventHandler('esx_doj:putStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_doj:getOtherPlayerData', function(source, cb, target)
  ...
  if Config_esx_doj.EnableESXIdentity then
    ...
    if Config_esx_doj.EnableLicenses then
...
ESX.RegisterServerCallback('esx_doj:getArmoryWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_doj:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_doj:removeArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_doj:buy', function(source, cb, amount)
...
ESX.RegisterServerCallback('esx_doj:getStockItems', function(source, cb)
...
ESX.RegisterServerCallback('esx_doj:getPlayerInventory', function(source, cb)
