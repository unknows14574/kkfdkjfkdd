...
ConfigModeration.Peds = {"a_c_boar","a_c_cat_01","a_c_chickenhawk","a_c_chimp","a_c_chop","a_c_cormorant","a_c_cow","a_c_coyote","a_c_crow","a_c_deer","a_c_dolphin",
...
ConfigModeration.Peds_Addons = {"Zeus","a_c_husky"}

ConfigModeration.Weapons = {
	{ id = "weapon_unarmed", name = "--- [Melee] ---" },
	{ id = "weapon_dagger", name = "Poignard" },
	{ id = "weapon_bat", name = "Batte" },
	{ id = "weapon_bottle", name = "Bouteille" },
	{ id = "weapon_crowbar", name = "Pied de biche" },
	{ id = "weapon_flashlight", name = "Lampe torche" },
	{ id = "weapon_golfclub", name = "Club de golf" },
	{ id = "weapon_hammer", name = "Marteau" },
	{ id = "weapon_hatchet", name = "Hachette" },
	{ id = "weapon_knuckle", name = "Poing américain" },
	{ id = "weapon_knife", name = "Couteau" },
	{ id = "weapon_machete", name = "Machette" },
	{ id = "weapon_switchblade", name = "Couteau à cran d\'arrêt" },
	{ id = "weapon_nightstick", name = "Matraque" },
	{ id = "weapon_wrench", name = "Clé" },
	{ id = "weapon_battleaxe", name = "Hache de combat" },
	{ id = "weapon_poolcue", name = "Queue de billard" },
	{ id = "weapon_stone_hatchet", name = "Katana" },
	{ id = "weapon_pistol", name = "Pistolet" },
	{ id = "weapon_pistol_mk2", name = "Glock 20" },
	{ id = "weapon_combatpistol", name = "Pistolet de combat" },
	{ id = "weapon_appistol", name = "Pistolet automatique" },
	{ id = "weapon_stungun", name = "Tazer" },
	{ id = "weapon_pistol50", name = "Pistolet calibre 50" },
	{ id = "weapon_snspistol", name = "Pistolet sns" },
	{ id = "weapon_snspistol_mk2", name = "1991" },
	{ id = "weapon_heavypistol", name = "Pistolet lourd" },
	{ id = "weapon_vintagepistol", name = "Pistolet vintage" },
	{ id = "weapon_flaregun", name = "Lance fusée de détresse" },
	{ id = "weapon_marksmanpistol", name = "Pistolet marksman" },
	{ id = "weapon_revolver", name = "Revolver lourd" },
	{ id = "weapon_revolver_mk2", name = "Magnum44" },
	{ id = "weapon_doubleaction", name = "Revolver Double-Action" },
	{ id = "weapon_raypistol", name = "Pistolet laser" },
	{ id = "weapon_unarmed", name = "--- [Submachine Guns] ---" },
	{ id = "weapon_microsmg", name = "Micro SMG" },
	{ id = "weapon_smg", name = "SMG" },
	{ id = "weapon_smg_mk2", name = "AK-12" },
	{ id = "weapon_assaultsmg", name = "SMG d\'assaut" },
	{ id = "weapon_combatpdw", name = "Arme de défense personnelle" },
	{ id = "weapon_machinepistol", name = "Pistolet mitrailleur" },
	{ id = "weapon_minismg", name = "Mini SMG" },
	{ id = "weapon_raycarbine", name = "Dézinguator inférnal" },
	{ id = "weapon_unarmed", name = "--- [Shotguns] ---" },
	{ id = "weapon_pumpshotgun", name = "Fusil à pompe" },
	{ id = "weapon_pumpshotgun_mk2", name = "Remington 870" },
	{ id = "weapon_sawnoffshotgun", name = "Carabine à canon scié" },
	{ id = "weapon_assaultshotgun", name = "Pompe d\'assaut" },
	{ id = "weapon_bullpupshotgun", name = "Pompe Bullpup" },
	{ id = "weapon_musket", name = "Mousquet" },
	{ id = "weapon_heavyshotgun", name = "Fusil à pompe lourd" },
	{ id = "weapon_dbshotgun", name = "Fusil à pompe double canon" },
	{ id = "weapon_autoshotgun", name = "Fusil à pompe automatique" },
	{ id = "weapon_unarmed", name = "--- [Assault Rifles] ---" },
	{ id = "weapon_assaultrifle", name = "AK-47" },
	{ id = "weapon_assaultrifle_mk2", name = "AKS-74U" },
	{ id = "weapon_carbinerifle", name = "Carabine d\'assaut" },
	{ id = "weapon_carbinerifle_mk2", name = "M4" },
	{ id = "weapon_advancedrifle", name = "Fusil avancé" },
	{ id = "weapon_specialcarbine", name = "Carabine spéciale" },
	{ id = "weapon_specialcarbine_mk2", name = "SCAR-H" },
	{ id = "weapon_bullpuprifle", name = "Fusil bullpup" },
	{ id = "weapon_bullpuprifle_mk2", name = "Fusil bullpup Mk II" },
	{ id = "weapon_compactrifle", name = "Fusil compact" },
	{ id = "weapon_unarmed", name = "--- [Light Machine Guns] ---" },
	{ id = "weapon_mg", name = "Mitrailleuse" },
	{ id = "weapon_combatmg", name = "Mitrailleuse de combat" },
	{ id = "weapon_combatmg_mk2", name = "Mitrailleuse de combat Mk II" },
	{ id = "weapon_gusenberg", name = "Balayeuse gusenberg" },
	{ id = "weapon_unarmed", name = "--- [Sniper Rifles] ---" },
	{ id = "weapon_sniperrifle", name = "Fusil de sniper" },
	{ id = "weapon_heavysniper", name = "Fusil de sniper lourd" },
	{ id = "weapon_heavysniper_mk2", name = "Winchester 70" },
	{ id = "weapon_marksmanrifle", name = "Fusil marksman" },
	{ id = "weapon_marksmanrifle_mk2", name = "Fusil marksman Mk II" },
	{ id = "weapon_unarmed", name = "--- [Heavy Weapons] ---" },
	{ id = "weapon_rpg", name = "Lance-rocket" },
	{ id = "weapon_grenadelauncher", name = "Lance-grenade" },
	{ id = "weapon_minigun", name = "Minigun" },
	{ id = "weapon_firework", name = "Feu d\'artifice" },
	{ id = "weapon_railgun", name = "Canon éléctrique" },
	{ id = "weapon_hominglauncher", name = "Lance tête-chercheuse" },
	{ id = "weapon_compactlauncher", name = "Lanceur compact " },
	{ id = "weapon_rayminigun", name = "Widowmaker" },
	{ id = "weapon_unarmed", name = "--- [Throwables] ---" },
	{ id = "weapon_grenade", name = "Grenade" },
	{ id = "weapon_bzgas", name = "Grenade à gaz bz" },
	{ id = "weapon_molotov", name = "Cocktail molotov" },
	{ id = "weapon_stickybomb", name = "Bombe collante" },
	{ id = "weapon_proxmine", name = "Mine de proximité" },
	{ id = "weapon_snowball", name = "Boule de neige" },
	{ id = "weapon_pipebomb", name = "Bombe tuyau" },
	{ id = "weapon_ball", name = "Balle" },
	{ id = "weapon_smokegrenade", name = "Grenade fumigène" },
	{ id = "weapon_flare", name = "Fusée détresse" },
	{ id = "weapon_unarmed", name = "--- [Miscellaneous] ---" },
	{ id = "weapon_petrolcan", name = "Jerry Can" },
	{ id = "gadget_parachute", name = "Parachute" },
	{ id = "weapon_fireextinguisher", name = "Extincteur" },
}